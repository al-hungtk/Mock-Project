    ...
    <div class="container">
        <form action="" method="post" role="form" enctype="multipart/form">
            ...
            <div class="form-group">
                ...
                <input type="text" name="category_Name" class="form-control" id="" placeholder="Input field">
                <label for="">moreinfo</label>
                <input type="text" name="more_Info" class="form-control" id="" placeholder="Input field">
            </div>
