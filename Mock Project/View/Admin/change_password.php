...
<body>
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="password" name="new_password" id="newPassword" placeholder="" required>
        </div>
        ...
        <button type="submit" class="btn btn-primary" name="action" value="post-change-password"
            id="submitChangePassword">Submit</button>
    </form>
    <!-- Optional JavaScript -->
